...
import com.picocli.CommandLine.Help.Ansi.IStyle;
import com.picocli.CommandLine.Help.Ansi.Style;
import com.picocli.CommandLine.Help.Ansi.Text;
import com.picocli.CommandLine.Model.*;

import static java.util.Locale.ENGLISH;
import static com.picocli.CommandLine.Model.ArgsReflection.abbreviate;
import static com.picocli.CommandLine.Help.Column.Overflow.SPAN;
import static com.picocli.CommandLine.Help.Column.Overflow.TRUNCATE;
import static com.picocli.CommandLine.Help.Column.Overflow.WRAP;
 ...
 * </p><h2>Example</h2>
 * <pre>import static com.picocli.CommandLine.*;
 *
...
public class CommandLine {
     ...
     * </p>
     * <pre>
     * import static com.picocli.CommandLine.*;
     *
    ...
    public static final class Model {
        ...
        private static class CommandReflection {
            ...
            private static void validateInjectSpec(TypedMember member) {
                ...
                if (member.getType() != CommandSpec.class) { throw new InitializationException("@com.picocli.CommandLine.Spec annotation is only supported on fields of type " + CommandSpec.class.getName()); }
            }
...
//                }
    ...
    /** Base class of all exceptions thrown by {@code com.picocli.CommandLine}.
